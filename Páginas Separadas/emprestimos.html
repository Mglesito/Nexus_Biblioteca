...
<nav class="nav">
  ...
  <a href="historico.html" class="">Histórico</a>
</nav>
...
<main class="main">
<div class="page-head"><div><h1>Cadastro de empréstimo</h1><p>Registre a retirada de livros pelos alunos.</p></div></div>
<div class="panel"><h2>Novo empréstimo</h2>
<div class="form-grid">
<div class="field"><label>Data do empréstimo</label><input type="date"></div>
<div class="field"><label>Aluno</label><select><option>Selecione um aluno</option></select></div>
<div class="field full"><label>Livro</label><select><option>Selecione um livro</option></select></div>
</div>
<p class="form-note">Selecione um aluno sem empréstimo ativo e um livro disponível.</p>
<button class="btn-primary small" type="button">Registrar empréstimo</button>
</div>
<div class="section-row"><h2>Empréstimos ativos</h2></div>
<div class="table-wrap"><table><thead><tr><th>Data</th><th>Aluno</th><th>Turma</th><th>Livro</th><th>Devolução</th><th>Status</th><th>Ações</th></tr></thead>
<tbody><tr><td colspan="7" style="text-align:center;color:var(--ink-soft)">Nenhum empréstimo ativo.</td></tr></tbody></table></div>
</main>
</body>
</html>
