...
<main class="main">
<div class="page-head"><div><h1>Meu empréstimo</h1><p>Situação da sua retirada atual.</p></div></div>
<div class="empty-state">
  <h3>Nenhum empréstimo carregado</h3>
  <p>Os empréstimos do aluno serão exibidos aqui quando houver dados no sistema.</p>
</div>
</main>
</body>
</html>
